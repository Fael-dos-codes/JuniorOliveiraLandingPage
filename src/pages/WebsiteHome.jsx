    ...
    <div className="relative w-full min-h-screen bg-background flex flex-col items-center justify-center py-12 px-6">
      ...
      <div className="relative z-10 w-full max-w-md flex flex-col items-center mt-10">
        ...
        <div className="w-full flex flex-col gap-4">
          ...
          <Link to="/campanha" className="group relative w-full bg-dark/50 border border-white/5 text-text p-4 rounded-2xl flex items-center justify-between hover:border-accent/50 hover:bg-white/5 transition-all">
